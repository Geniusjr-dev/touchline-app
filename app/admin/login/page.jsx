...
export default function Login() {
  ...
  return (
    <div data-admin-theme data-theme={mode} style={{ minHeight: "100vh", background: t.page, color: t.text, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ width: "100%", maxWidth: 360 }}>
        <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 12 }}><button type="button" onClick={toggle} style={{ background: t.pill, color: t.text, border: `1px solid ${t.pillBorder}`, borderRadius: 8, padding: "6px 10px", cursor: "pointer" }}>{mode === "dark" ? "Light mode" : "Dark mode"}</button></div>
