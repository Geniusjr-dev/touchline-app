...
export const saveMatchStats = (matchId, stats) =>
  supabase.rpc("save_match_statistics", {
    p_match_id: matchId,
    p_home_possession: Number(stats.home_possession),
    p_away_possession: Number(stats.away_possession),
    p_home_total_shots: Number(stats.home_total_shots),
    p_away_total_shots: Number(stats.away_total_shots),
    p_home_shots_on_target: Number(stats.home_shots_on_target),
    p_away_shots_on_target: Number(stats.away_shots_on_target),
    p_home_corners: Number(stats.home_corners),
    p_away_corners: Number(stats.away_corners),
    p_home_fouls: Number(stats.home_fouls),
    p_away_fouls: Number(stats.away_fouls),
    p_home_offsides: Number(stats.home_offsides),
    p_away_offsides: Number(stats.away_offsides),
    p_home_yellow_cards: Number(stats.home_yellow_cards),
    p_away_yellow_cards: Number(stats.away_yellow_cards),
    p_home_red_cards: Number(stats.home_red_cards),
    p_away_red_cards: Number(stats.away_red_cards),
  });
