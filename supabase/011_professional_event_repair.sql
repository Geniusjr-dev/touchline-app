-- Touchline migration 011
-- This file replaces migration 010 when 010 has not completed successfully.
...
begin
  for constraint_record in
    ...
    where constraint_name.conrelid = 'public.events'::regclass
      and constraint_name.contype = 'c'
      and pg_get_constraintdef(constraint_name.oid) ilike '%goal_type%'
  loop
    execute format(
